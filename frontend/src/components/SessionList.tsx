/**
 * 会话列表组件
 * 显示进行中和已结束的会话，支持筛选和搜索
 */

import { useState, useEffect } from 'react';
import type { SessionStatus, SessionDealStatus } from '../types';
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex flex-wrap gap-3">
          ...
          <select
            ...
            onChange={(e) => setDealStatusFilter(e.target.value as SessionDealStatus | '')}
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
            <option value="">全部成交状态</option>
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-medium text-gray-800">会话 #{session.id}</span>
